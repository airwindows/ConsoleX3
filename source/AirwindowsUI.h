...
struct AirwindowsMeter : public juce::Component
{
    ...
    juce::String displayTrackLetter = juce::String();
    ...
    void pushInput(float X) {blinkenInput = X;}
    void pushDisplay(float X) {blinkenDisplay = X;}
    void pushComp(float X) {blinkenComp = X;}
    void pushTape(float X) {blinkenTape = X;}
    void pushOutput(float X) {blinkenOutput = X;}
